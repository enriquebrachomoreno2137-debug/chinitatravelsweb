function seedDatabase(db) {
  ...
  const nd = (t, c, cat, date) => n(t, c, cat, date);

  nd('Aeropostal Alas de Venezuela - Nuevo itinerario temporal Valencia-Porlamar',
  ...
  nd('Plus Ultra Líneas Aéreas - Reanudación de operaciones 30 de junio',
  ...
  nd('Rutaca Airlines - Plan de contingencia 29 de junio',
  ...
  nd('Avianca habilita temporalmente operación entre Bogotá y Valencia',
  ...
  nd('Rutaca Airlines - Plan de contingencia 28 de junio',
  ...
  nd('Turpial Airlines - Vuela a Bogotá',
  ...
  nd('Turpial Airlines - Vuela a San Antonio del Táchira',
  ...
  nd('Aeropostal Alas de Venezuela - Vuelos especiales 28 de junio',
  ...
  nd('Comunicado Oficial Conviasa - Reprogramación de Vuelos por eventos sísmicos',
